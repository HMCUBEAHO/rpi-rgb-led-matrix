...
void runExample(int userInput) {
    ...
    const char *baseCommand = "sudo ./demo --led-rows=64 --led-cols=64 --led-chain-length=6 --led-pixel-mapper "U-mapper;Rotate:0" --led-gpio-mapping=adafruit-hat --led-brightness=40 -D ";
